...
const Onboarding1 = () => {
  // State voor het bijhouden van schermoriëntatie, getoonde tekst en antwoordstatus
  ...
  // Effect voor het geleidelijk weergeven van een begroetingstekst
  useEffect(() => {
    // Begroetingstekst instellen
      ...
      {orientation === "Landscape" ? (
        <>
          ...
          <svg
            ...
            className="character-svg onboarding"
          >
            <path
